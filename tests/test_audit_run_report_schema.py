...
class AuditRunReportSchemaTests(unittest.TestCase):
    ...
    def test_valid_audit_run_report_instance(self):
        valid_report = {
            ...
            "per_point_measurements": [
                {
                    ...
                    "finding_counts": {"total": 2, "open": 1, "resolved": 1},
                }
            ],
    ...
    def test_no_suppression_fields_in_v070_report_schema(self):
        valid_report = {
            "report_id": "report_0123456789abcdef",
            "schema_version": "1.0",
            "scope": "audit_run",
            ...
            "per_point_measurements": [
                {
                    ...
                    "baseline_version_id": "baseline_v0001",
                    "baseline_model_digest": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
                    "finding_counts": {"total": 0, "open": 0, "resolved": 0},
                }
            ],
            "evidence_references": [],
            "privacy_profile": "share_safe",
            "report_digest": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
            # Additional property active_suppressions is forbidden in v0.7.0 report schema
            "active_suppressions": [],
        }
